...
niri msg action move-workspace-to-index 1 --reference "1browser"
niri msg action move-workspace-to-index 2 --reference "2terminal"
niri msg action move-workspace-to-index 3 --reference "3other"
