...
config.keys = {
  ...
  },
  {
    ...
    mods = 'LEADER',
    action = wezterm.action_callback(function(window, pane)
      navigate_panes_with_zoom(window, pane, 'Left')
    end),
  },
  {
    key = 'j',
    mods = 'LEADER',
    action = wezterm.action_callback(function(window, pane)
      navigate_panes_with_zoom(window, pane, 'Down')
    end),
  },
  {
    key = 'k',
    mods = 'LEADER',
    action = wezterm.action_callback(function(window, pane)
      navigate_panes_with_zoom(window, pane, 'Up')
    end),
  },
  {
    key = 'l',
    mods = 'LEADER',
    action = wezterm.action_callback(function(window, pane)
      navigate_panes_with_zoom(window, pane, 'Right')
    end),
  },
  {
    key = 'H',
