...
require('lazy').setup({
...

  {
    ...
    config = function()
      ...
      vim.g.undotree_TreeNodeShape = "󱤆"
...
vim.cmd 'highlight SpellBad gui=underline guisp=#db4b4b'
vim.cmd 'highlight SpellCap gui=underline guisp=#e0af68'
vim.cmd 'highlight SpellLocal gui=underline guisp=#0db9d7'
vim.cmd 'highlight SpellRare gui=underline guisp=#1abc9c'
