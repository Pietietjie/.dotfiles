...
ls.add_snippets("all", {
  ...
  s(":docs:", fmt("📝 {}", { i(1) })),
  s(":deploy:", fmt("🚀 {}", { i(1) })),
  s(":style_code:", fmt("🎨 {}", { i(1) }), { alias = { ":formatting:" } }),
  s(":style_ui:", fmt("💄 {}", { i(1) })),
  s(":remove:", fmt("🔥 {}", { i(1) })),
  s(":work_in_progress:", fmt("🚧 {}", { i(1) })),
  s(":tests_add:", fmt("✅ {}", { i(1) })),
  s(":add_dependency:", fmt("➕ {}", { i(1) })),
  s(":remove_dependency:", fmt("➖ {}", { i(1) })),
  s(":upgrade_dependency:", fmt("⬆️ {}", { i(1) })),
  s(":downgrade_dependency:", fmt("⬇️ {}", { i(1) })),
  s(":pin_dependency_version:", fmt("📌 {}", { i(1) })),
  s(":add_comments:", fmt("💡 {}", { i(1) })),
  s(":refactor:", fmt("♻️ {}", { i(1) })),
  s(":new_package:", fmt("📦 {}", { i(1) })),
  s(":configuration:", fmt("🔧 {}", { i(1) })),
  s(":internationalization:", fmt("🌐 {}", { i(1) }), { alias = { ":i18n:" } }),
  s(":typo:", fmt("✏️ {}", { i(1) })),
  s(":revert:", fmt("⏪ {}", { i(1) })),
  s(":remove_linter_warning:", fmt("🚨 {}", { i(1) })),
  s(":fix_ci:", fmt("💚 {}", { i(1) })),
  s(":security:", fmt("🔒 {}", { i(1) })),
  s(":add_logs:", fmt("🔊 {}", { i(1) })),
  s(":remove_logs:", fmt("🔇 {}", { i(1) })),
  s(":ux:", fmt("🚸 {}", { i(1) })),
  s(":add_ci:", fmt("👷 {}", { i(1) })),
  s(":analytics:", fmt("📈 {}", { i(1) }), { alias = { ":tracking:" } }),
  s(":accessibility:", fmt("♿ {}", { i(1) })),
  s(":comments:", fmt("💡 {}", { i(1) })),
  s(":add_text:", fmt("💬 {}", { i(1) })),
  s(":add_contributors:", fmt("👥 {}", { i(1) })),
  s(":infrastructure:", fmt("🏗️ {}", { i(1) })),
  s(":responsive:", fmt("📱 {}", { i(1) })),
  s(":mocking_test:", fmt("🤡 {}", { i(1) })),
  s(":gitignore:", fmt("🙈 {}", { i(1) })),
  s(":add_snapshots:", fmt("📸 {}", { i(1) })),
  s(":experiment:", fmt("⚗️ {}", { i(1) })),
  s(":seo:", fmt("🔍 {}", { i(1) })),
  s(":add_seed_file:", fmt("🌱 {}", { i(1) })),
  s(":add_feature_flag:", fmt("🚩 {}", { i(1) })),
  s(":catch_errors:", fmt("🥅 {}", { i(1) })),
  s(":add_animations:", fmt("💫 {}", { i(1) })),
  s(":deprecated:", fmt("🗑️ {}", { i(1) })),
  s(":authentication:", fmt("🛂 {}", { i(1) })),
  s(":simple_fix:", fmt("🩹 {}", { i(1) })),
  s(":data_exploration:", fmt("🧐 {}", { i(1) })),
  s(":dead_code:", fmt("⚰️ {}", { i(1) })),
  s(":add_failing_test:", fmt("🧪 {}", { i(1) })),
  s(":business_logic:", fmt("👔 {}", { i(1) })),
  s(":database:", fmt("🗂️ {}", { i(1) }), { alias = { ":db:" } }),
  s(":breaking_changes:", fmt("💥 {}", { i(1) })),
  s(":fix_external_api:", fmt("👽 {}", { i(1) })),
  s(":initial_commit:", fmt("🎉 {}", { i(1) })),
  s(":code_cleanup:", fmt("🛁 {}", { i(1) })),
  s(":improve_code:", fmt("💎 {}", { i(1) })),
